  ...
  <section className="bg-gray-50 py-16 md:py-24">
    <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
      <div className="flex flex-col items-center md:items-end">
        <img src="./public/media/coton-bio.jpg" alt="Champ de coton bio" className="rounded-2xl shadow-lg w-full max-w-md mt-4" />
      </div>
      <div>
        ...
        <div className="flex gap-4 mb-4">
          <img src="./public/media/gots.svg" alt="GOTS" className="h-8" />
          <img src="./public/media/oeko-tex.svg" alt="Oeko-Tex" className="h-8" />
          <img src="./public/media/organic-cotton.svg" alt="Organic Cotton" className="h-8" />
        </div>
