    ...
    <section className="max-w-[1200px] mx-auto px-6 py-10">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
        <div className="p-6 border rounded-lg flex items-start gap-4">
          <img src="./public/media/fibres-bio.svg" alt="Coton bio" className="h-14 w-14" />
          <div>
        ...
        <div className="p-6 border rounded-lg flex items-start gap-4">
          <img src="./public/media/fibres-recyclees.svg" alt="Fibres recyclées" className="h-14 w-14" />
          <div>
        ...
        <div className="p-6 border rounded-lg flex items-start gap-4">
          <img src="./public/media/icon.svg" alt="Savoir-faire" className="h-14 w-14" />
          <div>
