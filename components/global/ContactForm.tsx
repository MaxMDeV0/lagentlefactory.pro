...
const ContactForm: React.FC = () => {
  ...
  return (
    <section id="contact" className="relative bg-cover bg-center py-24 min-h-[700px] flex items-center" style={{ backgroundImage: "url('media/equipe-lgf-escalier.png')" }}>
      {/* Overlay for better readability on mobile */}
      <div className="absolute inset-0  bg-black/15 z-10" aria-hidden="true"></div>
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 w-full">
        <div className="flex flex-col md:flex-row items-start gap-12">
          ...
          <div className="w-full md:w-1/2 lg:w-1/2">
            <div className="md:pr-12 lg:pr-0">
              <h3 className="text-white font-extrabold text-4xl xl:text-5xl leading-tight mb-6 drop-shadow-lg">
                Besoin d'un devis ou d'un premier échange ?
              </h3>
              <p className="text-white/95 font-bold text-xl leading-relaxed max-w-[450px] drop-shadow-lg">
