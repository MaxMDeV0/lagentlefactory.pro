    ...
    >
      ...
      <div className="relative z-20 max-w-[1200px] mx-auto px-6 w-full">
        <div className="flex flex-col items-center text-center gap-8">
          ...
          <div className="w-full max-w-[850px] bg-black/30 backdrop-blur-sm p-8 md:p-12 rounded-3xl border border-white/10">
            <ul className="text-left text-2xl md:text-3xl lg:text-[2.2rem] leading-snug space-y-4 mb-10" role="list">
              <li className="flex items-start gap-4">
                <span className="mt-2 block w-3 h-3 bg-white rounded-full flex-shrink-0"></span>
